...
def generate_daily_stats_plot(daily_summary_melted):
    ...
    title_font_size=24)
    fig.write_html("site/static/daily_stats.html",include_plotlyjs='cdn')
def generate_commute_delay_plot(commute_delay_counts):
    ...
    margin=dict(l=20, r=20, t=50, b=20),
    title_font_size=24)
    fig_commute_delay.write_html("site/static/commute_delay.html",include_plotlyjs='cdn')
def generate_delay_minutes_plot(unique_trips):
    ...
    margin=dict(l=20, r=20, t=50, b=20),
    title_font_size=24)
    fig_delay_minutes.write_html("site/static/delay_minutes.html",include_plotlyjs='cdn')
def save_graphs(df):
...
def main():
    ...
    with open("site/static/on_time_percentage.txt", "w") as f:
        f.write(f"{on_time_percentage:.2f}%")
    with open("site/static/stop_date.txt", "w") as f:
        f.write(f"{stop_date}")
    with open("site/static/start_date.txt", "w") as f:
        f.write(f"{start_date}")
    with open("site/static/n_datapoints.txt", "w") as f:
